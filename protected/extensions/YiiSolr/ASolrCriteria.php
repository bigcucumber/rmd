...
//        echo $condition;
    ...
    public $condition = '';
    public function addMutiCondition($condition,$operator="AND")
    {
        if(is_array($condition))
        {
            if($condition===array())
...
//        echo $condition . ' ' . $operator .' ';
        $this -> condition .= $condition . ' ' . $operator . ' ';
        return $this;
    }


    /**
     * 将条件字符串整理,一起add到filterQuery中
     */
    public function excute()
    {
        $condition = trim(trim($this -> condition,' OR '),' AND ');
...
//        echo $condition;
    ...
    public function getConditionString()
    {
        if($this -> condition == '')
            return '*';
        return trim(trim($this -> condition,' OR '),' AND ');
    }
